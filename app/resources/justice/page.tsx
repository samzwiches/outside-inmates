...
export const metadata: Metadata = {
  title: "Jails, Prisons, and Courts by State | Outside Inmates",
  description: "Find official jail, corrections, and court contacts by state, with links into the Outside Inmates resource directory.",
};
...
export default async function JusticeDirectoryPage() {
  ...
  return <><a className="skip-link" href="#main-content">Skip to content</a><SiteHeader /><main id="main-content" className="justice-directory-page">
    <PageHero variant="page" mediaKey="resources.hero" eyebrow="Official contacts" breadcrumbLabel="Jails + Courts" title="Find jails, corrections, and courts by state." description="Choose a state to open the official-contact listings in the Resource Finder. We are building this as a national directory of facility, custody, court, clerk, and corrections information." />

    <section className="section justice-directory-intro" aria-labelledby="justice-directory-heading"><div className="container"><div className="section-split-heading"><SectionHeading eyebrow="All 50 states + DC" id="justice-directory-heading" title="Start with the state where the arrest, case, facility, or supervision is located." description="State corrections systems and court systems are different from local county jails and local courts. The directory keeps them together while clearly labeling the source so you can verify details directly." /><Link className="button button-secondary" href="/resources">Open full Resource Finder <span aria-hidden="true">→</span></Link></div>
