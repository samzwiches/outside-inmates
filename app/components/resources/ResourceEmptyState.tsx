...
const copy = {
  ...
  unavailable: { title: "The directory is not available right now.", body: "This sample experience has no live directory connection yet. Please try again later or use the support links in the site footer.", action: "Back to resources" },
};
