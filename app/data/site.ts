...
export const pathways: Pathway[] = [
  {
    title: "My loved one was just incarcerated",
    detail: "First steps, locating someone, and what to expect next.",
    accent: "clay",
  },
  {
    title: "I need visitation or communication information",
    detail: "Calls, mail, visitation, and staying connected.",
    accent: "blue",
  },
  {
    title: "I am preparing for release",
    detail: "A practical checklist for the weeks ahead.",
    accent: "sage",
  },
  {
    title: "I need housing, employment, or identification help",
    detail: "Start with essentials that make the next steps possible.",
    accent: "clay",
  },
  {
    title: "I need legal or advocacy resources",
    detail: "Find trusted guidance and know what questions to ask.",
    accent: "blue",
  },
  {
    title: "I feel overwhelmed and need support",
    detail: "Take one small step. You do not have to carry this alone.",
    accent: "sage",
  },
];
...
export const forumPosts: ForumPost[] = [
  {
    title: "How do I find out where my brother was transferred?",
    category: "Family navigation",
    replies: 12,
    time: "2h ago",
  },
  {
    title: "What identification can someone get before release?",
    category: "Reentry basics",
    replies: 8,
    time: "5h ago",
  },
  {
    title: "How do I explain incarceration to a child?",
    category: "Family support",
    replies: 21,
    time: "Yesterday",
  },
  {
    title: "Housing options after a felony conviction",
    category: "Housing",
    replies: 34,
    time: "Yesterday",
  },
