...
export default async function SiteMediaAdminPage() {
  ...
  return <main className="admin-shell"><div className="container admin-topline"><Link className="wordmark" href="/" aria-label="Outside Inmates home">Outside <em>Inmates</em></Link><div className="admin-topline-actions"><Link className="quiet-link" href="/admin">Admin home <span aria-hidden="true">→</span></Link><SignOutButton config={config} /></div></div><SiteMediaEditor media={media} appearances={appearances} supabaseConfig={config} /></main>;
}
